  ...
  return (
    <DashboardLayout>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Get your questions answered by expert tutors.</p>
      </div>
      
      <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center">
        <h3 className="text-lg font-medium mb-2">Doubt Resolution page is under construction</h3>
